...
/**
 * Represents a builder that can builds an animation by specifying
 * shapes and there motion. The document in which the animation will be built.
 * @param <Doc> the document to build the animation in.
 */
